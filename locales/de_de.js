...
const lang = {
  ...
  common: {
    ...
    turnOff: 'abschalten',
    tasks: 'Aufgaben',
    batchOperation: 'Stapelverarbeitung',
    examples: 'Beispiele',
    importFromCSV: 'Aus CSV-Datei importieren',
  ...
  setting: {
    ...
    initDefaultTabOnStart: 'Standard-Registerkarte beim Start öffnen',
    screenReaderMode: 'Bildschirmlesegerät im Terminal unterstützen',
    makeItPortable: 'Portabel machen',
    dataTransferedTo: 'Daten übertragen auf',
    autoRefreshWhenSwitchToSftp: 'Automatisch aktualisieren beim Wechsel zu SFTP',
    terminalWordSeparator: 'Terminal-Worttrennzeichen',
    ...
    addTimeStampToTermLog: 'Zeitstempel zum Terminal-Protokoll hinzufügen',
    terminalBackSpaceMode: 'Terminal-Backspace-Sequenz',
    showHiddenFilesOnSftpStart: 'Versteckte Dateien beim SFTP-Start anzeigen',
