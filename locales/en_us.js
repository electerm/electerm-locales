...
const lang = {
  ...
  app: {
    ...
    desc: 'Terminal/ssh/sftp/ftp/telnet/serialport/RDP/VNC/Spice client for Linux, Windows, Mac, Android, HarmonyOS',
    single: 'single',
    ...
    copied: 'copied',
    moveTo: 'move to...',
    roleAI: 'role for creating terminal commands with AI',
    roleExplainAI: 'role for explaining terminal output with AI',
    modelAi: 'AI model',
  ...
  // ssh tabs
  tabs: {
    titleEmptyWarn: 'title cannot be empty',
    close: 'close',
  ...
  setting: {
    ...
    hotkeyNotOk: 'hotkey cannot be registered, please use another one',
    saved: 'saved',
    saveLang: 'saved, restart to take effect',
    restartNow: 'restart now',
    hotkeyDesc: 'system hotkey (bring window back to front)',
    timeoutDesc: 'ssh/sftp timeout (in milliseconds)',
    scrollBackDesc: 'scrollback lines',
    language: 'language',
    copyWhenSelect: 'copy selected text on selection',
    ...
    ctrlOrMetaOpenTerminalLink: 'must hold ctrl or meta (in mac) when clicking to open terminal link',
    ...
    openAll: 'open all bookmarks in this category',
    useSystemTitleBar: 'use system title bar',
    useSystemTitleBarTip: 'requires restarting the app to take effect; transparency does not work with the system title bar',
    ...
    initDefaultTabOnStart: 'open default tab when the app starts',
    screenReaderMode: 'support screen readers in terminal',
    makeItPortable: 'make it portable',
    dataTransferedTo: 'data transferred to',
    autoRefreshWhenSwitchToSftp: 'auto refresh when switching to sftp',
    ...
    allowMultiInstance: 'allow multiple instances',
    disableDeveloperTool: 'disable developer tools'
  },
  ...
  sftp: {
    ...
    mergeDesc: 'merge the remaining conflicting folders',
    overwriteDesc: 'overwrite the remaining conflicting files',
    mergeAll: 'merge all',
    overwriteAll: 'overwrite all',
    renameDesc: 'rename the remaining files/folders',
    folder: 'folder',
    file: 'file',
    ...
    delTip1: 'and all the files/directories in them',
  ...
  form: {
    ...
    passphraseDesc: 'passphrase for private key',
    host: 'host',
    username: 'username',
    port: 'port',
    title: 'title',
    ...
    loginScriptTip: 'run script after login',
    connect: 'connect',
    ...
    createBookmarkByAI: 'create bookmark with AI',
    ...
    enableTerminalImage: 'support terminal images',
  ...
  settingSync: {
    ...
    synced: 'synced',
    syncDesc: 'sync bookmarks / history / settings to a GitHub secret gist',
    autoSync: 'auto sync',
