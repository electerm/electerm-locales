...
const lang = {
  ...
  app: {
    ...
    desc: 'Terminal/SSH/SFTP/FTP/Telnet/seri port/RDP/VNC/Spice istemcisi için Linux, Windows, Mac, Android, HarmonyOS',
    single: 'Tek',
  ...
  common: {
    ...
    delSelected: 'seçileni sil',
    turnOff: 'kapat',
    tasks: 'görevler',
    batchOperation: 'toplu işlem',
    examples: 'örnekler',
    importFromCSV: 'CSV dosyasından içe aktar',
  ...
  quickCommands: {
    ...
    labels: 'etiket',
    sortByFrequency: 'kullanım sıklığına göre sırala'
  },
