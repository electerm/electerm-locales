...
const lang = {
  ...
  setting: {
    ...
    terminalWordSeparator: 'Разделитель слов терминала',
    ...
    showTabIndex: 'показать индекс вкладки'
  },
  ...
  ssh: {
    ...
    localToRemote: 'Перенаправить локальное соединение на удалённый сервер',
    remoteToLocal: 'Перенаправить удалённое соединение на локальный сервер',
