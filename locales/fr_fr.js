...
const lang = {
  ...
  app: {
    ...
    desc: 'Client Terminal/SSH/SFTP/FTP/Telnet/port série/RDP/VNC/Spice pour Linux, Windows, Mac, Android, HarmonyOS',
    single: 'Unique',
  ...
  cmdHistory: {
    ...
    moveToRightPanel: 'déplacer vers le panneau de droite',
    moveToFooter: 'déplacer vers le pied de page'
  }
}
