...
const lang = {
  ...
  app: {
    ...
    desc: 'Cliente de terminal/SSH/SFTP/FTP/Telnet/porta serial/RDP/VNC/Spice para Linux, Windows, Mac, Android, HarmonyOS',
    single: 'Único',
  ...
  setting: {
    ...
    openAll: 'abrir todos os favoritos nesta categoria',
  ...
  sftp: {
    ...
    mergeDesc: 'mesclar as pastas restantes em conflito',
    overwriteDesc: 'substituir os arquivos restantes em conflito',
    mergeAll: 'mesclar todos',
    overwriteAll: 'substituir todos',
    renameDesc: 'renomear os arquivos/pastas restantes',
    folder: 'pasta',
    file: 'arquivo',
  ...
  form: {
    ...
    loginScriptDelay: 'atraso na execução do script',
  ...
  ssh: {
    ...
    runInAllTerminals: 'executar em todos os terminais',
  ...
  // cmd history
  cmdHistory: {
    cmdHistory: 'histórico de comandos',
    moveToRightPanel: 'mover para o painel direito',
    moveToFooter: 'mover para o rodapé'
  }
}
